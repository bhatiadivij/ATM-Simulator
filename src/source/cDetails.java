...
public class cDetails extends javax.swing.JFrame {
    ...
    public void setmsg()
    {
         ...
         details.setText("Customer Name : "+GlobalAtm.customer.getName()+"\n"+"PAN Number : "+GlobalAtm.customer.getPanNum()+"\n" +"Aadhar Number : "+GlobalAtm.customer.getAadharNum()+"\n" +"Phone Number : "+GlobalAtm.customer.getPhone());
...
//    ImageIcon icon = new ImageIcon(imgURL); 
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(PastTransaction.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
